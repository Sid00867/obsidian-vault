...
this ensures that we capture some notion of a "action that results in a specific transition", given that we ensure that the IDM passes a highly compressed representation to the FDM, ensuring the IDM doesnt cheat by passing in the entire future 